package com.gruk.yegor.datakeeper.serialization.serializer.persistable.io;
...
public final class PersistableObjectInput implements DataInput {
    ...
    private final ThreadLocal<DoubleSerializer> doubleSerializer = new ThreadLocal<DoubleSerializer>();
    ...
    public PersistableObjectInput(BooleanSerializer booleanSerializer,
        ...
        this.doubleSerializer.set(doubleSerializer);
    ...
    public boolean readBoolean() {
        ...
        boolean b = booleanSerializer.deserialize(bytes, offset, 0);
        offset += length;
        return b;
    }
    ...
    public byte readByte() {
        ...
        byte b = byteSerializer.deserialize(bytes, offset, 0);
        offset += length;
        return b;
    }
    ...
    public short readShort() {
        ...
        short s = shortSerializer.deserialize(bytes, offset, 0);
        offset += length;
        return s;
    }
    ...
    public char readChar() {
        ...
        char c = charSerializer.deserialize(bytes, offset, 0);
        offset += length;
        return c;
    }
    ...
    public int readInt() {
        ...
        int i = integerSerializer.deserialize(bytes, offset, 0);
        offset += length;
        return i;
    }
    ...
    public long readLong() {
        ...
        long l = longSerializer.deserialize(bytes, offset, 0);
        offset += length;
        return l;
    }
    ...
    public float readFloat() {
        ...
        float f = floatSerializer.deserialize(bytes, offset, 0);
        offset += length;
        return f;
    }
    ...
    public double readDouble() {
        int length = doubleSerializer.get().bytesLength();
        checkBounds(length);
        byte flag = bytes[offset];
        if (!doubleSerializer.get().isMatches(flag)) {
            throw new ClassCastException(String.format(INCORRECT_DOUBLE_MESSAGE, flag));
        }
        double d = doubleSerializer.get().deserialize(bytes, offset, 0);
        offset += length;
        return d;
    }
